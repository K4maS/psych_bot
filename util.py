...
async def navigation(message, update, context):
    try:
        ...
        await update.message.reply_text("Произошла ошибка при навигации. Пожалуйста, попробуйте еще раз.", reply_markup=reply_markup_back_reset)
        return None
...
async def question_answer_base(update, context,  question_index):
    try:
        ...
        await update.message.reply_text("Произошла ошибка при обработке вашего ответа. Пожалуйста, попробуйте еще раз.", reply_markup=reply_markup_back_reset)
        return None
